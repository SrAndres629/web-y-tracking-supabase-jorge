...
from app.tracking import send_event, send_event_async, _build_payload
...
def test_build_payload_validation():
    ...
    with patch("app.tracking.logger") as mock_logger:
        ...
        warnings = [call.args[0] for call in mock_logger.warning.call_args_list if "⚠️ [VALIDATION]" in str(call)]
