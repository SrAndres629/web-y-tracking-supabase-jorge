...
class TestNoTrackingConflicts:
    ...
    @pytest.mark.parametrize("template", _find_all_templates(),
...
class TestBaseTemplateZaraz:
    ...
    def test_zaraz_comment_exists(self):
        ...
        assert "Cloudflare Zaraz" in content, \
            "No Zaraz reference found in base.html"
