...
SCRIPTS = {
    ...
    "copy": os.path.join(SKILLS_DIR, "copywriting-conversion/scripts/copy_manager.py"),
    "perf": os.path.join(SKILLS_DIR, "performance-optimization/scripts/perf_manager.py"),
    "seo": os.path.join(SKILLS_DIR, "seo-semantic-authority/scripts/seo_manager.py"),
    "resilience": os.path.join(SKILLS_DIR, "error-states-resilience/scripts/resilience_manager.py"),
    "social": os.path.join(SKILLS_DIR, "social-viral-metadata/scripts/social_manager.py"),
    "edge": os.path.join(SKILLS_DIR, "edge-mastery-ops/scripts/edge_manager.py"),
    "zaraz": os.path.join(SKILLS_DIR, "zaraz-tracking-architect/scripts/zaraz_manager.py"),
    "stitch": os.path.join(SKILLS_DIR, "stitch-vibe-translator/scripts/stitch_manager.py"),
}
