...
const REPLACEMENTS = [
  // CSS
  {
    ...
    to: '/static_new/dist/css/app.min.css',
    description: 'Main CSS bundle'
  },
  {
    from: /\/static\/css\/components\/ba-slider\.css/g,
    to: '/static_new/molecules/ba-slider/ba-slider.css',
  ...
  // JS - Legacy mode (recommended for gradual migration)
  {
    ...
    to: '<script type="module" src="/static_new/engines/legacy-adapter.js"></script>',
